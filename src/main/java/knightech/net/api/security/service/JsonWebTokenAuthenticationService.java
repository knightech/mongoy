...
import knightech.net.api.exception.model.UserNotFoundException;
import knightech.net.api.model.User;
import knightech.net.api.model.UserAuthentication;
import knightech.net.api.security.constants.SecurityConstants;
